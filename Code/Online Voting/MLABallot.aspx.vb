...
Partial Class MLABallot
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If id <> "" Then
            ...
            cmd.ExecuteNonQuery()
            reader.Close()
            cmd.CommandText = "update  VoterDB  set MLA='Yes' where VID='" + uid + "'"
            cmd.Connection = con
            cmd.ExecuteNonQuery()
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        reader.Close()
        cmd.CommandText = "select * from ContestantDB where   Constituency='" + consti + "' and Post='MLA'"
        cmd.Connection = con
        reader = cmd.ExecuteReader()
