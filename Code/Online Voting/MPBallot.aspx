<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MPBallot.aspx.vb" Inherits="MPBallot" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MP Ballot</title>
    <style>
        table {
...
<body>
    <form id="form1" runat="server">
        <div style="text-align: center; margin-left: auto; margin-right: auto; margin-top: 2cm;">
            <asp:Table ID="Table3" runat="server" Style="margin-left: auto; margin-right: auto; margin-top: 1cm;">
                <asp:TableHeaderRow>
                    <asp:TableHeaderCell>
            ...
            <asp:Table ID="Table2" runat="server" Style="margin-left: auto; margin-right: auto; margin-top: 1cm;">
                <asp:TableHeaderRow>
                    <asp:TableHeaderCell>
            ...
            <br/>
            <asp:Button ID="Button1" runat="server" Text="Vote" Height="31px" Width="94px" Style="margin-right: auto; margin-left: auto;" />
        </div>
    </form>
</body>
</html>
